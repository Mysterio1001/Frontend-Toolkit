...
- Check the read:packages scope before generating the token
- Replace `YOUR_GITHUB_TOKEN` in the code above with the generated `ghp_`... string
...
```Plaintext
@mysterio1001:registry=https://npm.pkg.github.com
//npm.pkg.github.com/:_authToken=您的_GITHUB_TOKEN
```
